...
import PIL
import pdb
from utils.parse_datasets import get_imdb
...
def combined_roidb(imdb_names, training=True):
  ...
  def get_roidb(imdb_name):
    ...
    imdb.set_proposal_method(model.TRAIN.PROPOSAL_METHOD)
    print('Set proposal method: {:s}'.format(model.TRAIN.PROPOSAL_METHOD))
